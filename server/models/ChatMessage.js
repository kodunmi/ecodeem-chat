...
const readByRecipientSchema = new mongoose.Schema(
  {
    _id: false,
    readByUserId: { type: mongoose.Schema.ObjectId, required: true},
    readAt: {
      type: Date,
      default: Date.now(),
    },
...
const chatMessageSchema = new mongoose.Schema(
  {
    chatRoomId: { type: mongoose.Schema.ObjectId, required: true},
    ...
    postedByUser: { type: mongoose.Schema.ObjectId, required: true},
 ...
 */
chatMessageSchema.statics.createPostInChatRoom = async function (chatRoomId, message, postedByUser, link, type ) {
  try {
